...
pathvector s > /tmp/pathvector-bgp-status/router1.txt

sleep 2s

####################################
#				   #
# Convert router1.txt to router1.csv #
#				   #
####################################

# Define input and output files
input_file="router1.txt"
output_file="router1.csv"
...
mv /tmp/pathvector-bgp-status/router1.csv /var/www/bgpstatus/
